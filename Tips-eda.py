...
st.sidebar.write("Using dashboard is using Tips dataset from seaborn for educational purposes.")
st.write("")
...
st.sidebar.write("")
st.sidebar.markdown("Made with by Eng. [Badreddine El Hainouni](https://www.linkedin.com/in/badreddine-el-hainouni-ab840223b/)")
